...
class TDClient():
    ...
    def __init__(self, client_id: str, redirect_uri: str = None, account_number: str = None, refresh_token: str = None,
        ...
        self.credentials_path = pathlib.Path(credentials_path) if credentials_path is not None else None
    ...
    def _state_manager(self, action: str) -> None:
        ...
        """
        # looks like this is used to saved credentials to a file. But we don't need that.
        # TODO: refactor everywhere that uses this method.
        pass
        # credentials_file_exists = self.credentials_path is not None
        #
    ...
    def login(self) -> bool:
        ...
        if self.credentials_path is not None and self._silent_sso():
            self.authstate = True
            return True
        else:
