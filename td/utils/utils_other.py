...
class OptionChain():
    ...
    def __init__(
        self,
        symbol: str = None,
        contract_type: Union[str, Enum] = 'all',
        strike_count: int = None,
        include_quotes: bool = False,
        strategy: Union[str, Enum] = 'single',
        interval: str = None,
        strike: float = None,
        opt_range: Union[str, Enum] = 'all',
        ...
        exp_month: Union[str, Enum] = 'all',
        option_type: Union[str, Enum] = 'all'
    ) -> None:
        ...
        if strategy not in StrategyType.__dict__:
            raise KeyError("The Strategy type you are using is in correct.")
