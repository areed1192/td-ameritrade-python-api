...
class TDSession(TestCase):
    ...
    def test_create_account_activity(self):
        ...
        self.assertIn(
            'ACCT_ACTIVITY', self.stream_session.data_requests['requests'][0]['service']
        )

    def test_subscribe_level_one_quotes(self):
        """Test subscribing to Level One Quotes."""

        self.stream_session.level_one_quotes(
            symbols=['MSFT', 'AAPL'],
            fields=list(range(0, 1, 38))
        )
        self.assertIn(
            'QUOTE',
            self.stream_session.data_requests['requests'][0]['service']
        )

    def test_subscribe_level_two_quotes(self):
        """Test subscribing to Level Two Quotes."""

        self.stream_session.level_two_quotes(
            symbols=['MSFT', 'AAPL'],
            fields=[0, 1, 2, 3]
        )
    ...
    def test_subscribe_level_one_options(self):
        ...
        self.stream_session.level_one_options(
    ...
    def test_subscribe_level_one_futures(self):
        ...
        # Level One Futures
        self.stream_session.level_one_futures(
            symbols=['/CL'],
            fields=[0, 1, 2, 3, 4, 5]
        )
        self.assertIn(
    ...
    def test_subscribe_level_one_forex(self):
        ...
        # Level One Forex
        self.stream_session.level_one_forex(
            symbols=['EUR/USD'],
    ...
    def test_subscribe_level_one_futures_options(self):
        ...
        self.stream_session.level_one_futures_options(
            symbols=['./E1AG20C3220'],
